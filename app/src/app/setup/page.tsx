        ...
        <section className="border-r border-panel-border bg-panel-soft p-5">
          ...
          <form onSubmit={submit} className="space-y-3">
            <Field
              ...
              mono
            />
            <Field label="ชื่อกำไล *" value={name} onChange={setName} placeholder="เช่น 'หัวหน้าทีม A'" required />
            <Field label="เจ้าของ" value={owner} onChange={setOwner} placeholder="ชื่อ-สกุล" />
            <Field label="บทบาท" value={role} onChange={setRole} placeholder="วิศวกร / คนงาน / โฟร์แมน" />
